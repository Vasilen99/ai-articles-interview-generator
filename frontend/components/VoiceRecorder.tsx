    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        if (audioBlob.size < 1000) {
          setError('Recording too short or empty. Please speak for at least 1 second.');
        ...
        try {
          ...
          console.log('Sending to transcribe API...', formData.get('audio'));
          ...
          if (!transcribedText) {
            ...
            if (fallbackText) {
              console.log('Using speech recognition transcript as fallback');
          ...
          const fallbackText = interimTranscriptRef.current.trim();
          if (fallbackText) {
            console.log('Whisper failed, using speech recognition transcript');
            setTranscript(fallbackText);
            onTranscript(fallbackText);
          } else {
